...
class EngineArgs:
    ...
    mxfp4_backend: str = ModelConfig.mxfp4_backend
    mxfp4_layers: str = ModelConfig.mxfp4_layers
    ...
    def add_cli_args(parser: FlexibleArgumentParser) -> FlexibleArgumentParser:
        ...
        model_group.add_argument("--mxfp4-backend", **model_kwargs["mxfp4_backend"])
        model_group.add_argument("--mxfp4-layers", **model_kwargs["mxfp4_layers"])
    ...
    def create_model_config(self) -> ModelConfig:
        ...
        return ModelConfig(
            ...
            mxfp4_layers=self.mxfp4_layers,
